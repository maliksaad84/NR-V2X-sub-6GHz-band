#include <ns3/log.h>
#include <ns3/abort.h>
#include "newradio-flex-tti-mac-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE ("newradioFlexTtiMacScheduler");

NS_OBJECT_ENSURE_REGISTERED (newradioFlexTtiMacScheduler);

class newradioFlexTtiMacCschedSapProvider : public newradioMacCschedSapProvider
{
public:
  newradioFlexTtiMacCschedSapProvider (newradioFlexTtiMacScheduler* scheduler);
...
private:
  newradioFlexTtiMacCschedSapProvider ();
  newradioFlexTtiMacScheduler* m_scheduler;
};

newradioFlexTtiMacCschedSapProvider::newradioFlexTtiMacCschedSapProvider ()
{
}

newradioFlexTtiMacCschedSapProvider::newradioFlexTtiMacCschedSapProvider (newradioFlexTtiMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
newradioFlexTtiMacCschedSapProvider::CschedCellConfigReq (const struct newradioMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
newradioFlexTtiMacCschedSapProvider::CschedUeConfigReq (const struct newradioMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
newradioFlexTtiMacCschedSapProvider::CschedLcConfigReq (const struct newradioMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
newradioFlexTtiMacCschedSapProvider::CschedLcReleaseReq (const struct newradioMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
newradioFlexTtiMacCschedSapProvider::CschedUeReleaseReq (const struct newradioMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

class newradioFlexTtiMacSchedSapProvider : public newradioMacSchedSapProvider
{
public:
  newradioFlexTtiMacSchedSapProvider (newradioFlexTtiMacScheduler* sched);
...
private:
  newradioFlexTtiMacSchedSapProvider ();
  newradioFlexTtiMacScheduler* m_scheduler;
};

newradioFlexTtiMacSchedSapProvider::newradioFlexTtiMacSchedSapProvider ()
{
}

newradioFlexTtiMacSchedSapProvider::newradioFlexTtiMacSchedSapProvider (newradioFlexTtiMacScheduler* sched)
  : m_scheduler (sched)
{
}

void
newradioFlexTtiMacSchedSapProvider::SchedDlRlcBufferReq (const struct newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
newradioFlexTtiMacSchedSapProvider::SchedTriggerReq (const struct newradioMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  m_scheduler->DoSchedTriggerReq (params);
}

void
newradioFlexTtiMacSchedSapProvider::SchedDlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
newradioFlexTtiMacSchedSapProvider::SchedUlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedUlCqiInfoReq (params);
}

void
newradioFlexTtiMacSchedSapProvider::SchedUlMacCtrlInfoReq (const struct newradioMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
newradioFlexTtiMacSchedSapProvider::SchedSetMcs (int mcs)
{
  m_scheduler->DoSchedSetMcs (mcs);
}

const unsigned newradioFlexTtiMacScheduler::m_macHdrSize = 0;
const unsigned newradioFlexTtiMacScheduler::m_subHdrSize = 4;
const unsigned newradioFlexTtiMacScheduler::m_rlcHdrSize = 3;

const double newradioFlexTtiMacScheduler::m_berDl = 0.001;

newradioFlexTtiMacScheduler::newradioFlexTtiMacScheduler ()
  : m_nextRnti (0),
    m_subframeNo (0),
    m_tbUid (0),
    m_macSchedSapUser (0),
    m_macCschedSapUser (0)
{
  ...
  m_macSchedSapProvider = new newradioFlexTtiMacSchedSapProvider (this);
  m_macCschedSapProvider = new newradioFlexTtiMacCschedSapProvider (this);
}
...
void
newradioFlexTtiMacScheduler::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  m_wbCqiRxed.clear ();
...
TypeId
newradioFlexTtiMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::newradioFlexTtiMacScheduler")
    .SetParent<newradioMacScheduler> ()
    .AddConstructor<newradioFlexTtiMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (100),
                   MakeUintegerAccessor (&newradioFlexTtiMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedMcsDl",
                   "Fix MCS to value set in McsDlDefault (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMacScheduler::m_fixedMcsDl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultDl",
                   "Fixed DL MCS (for testing)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&newradioFlexTtiMacScheduler::m_mcsDefaultDl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FixedMcsUl",
                   "Fix MCS to value set in McsUlDefault (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMacScheduler::m_fixedMcsUl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultUl",
                   "Fixed UL MCS (for testing)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&newradioFlexTtiMacScheduler::m_mcsDefaultUl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DlSchedOnly",
                   "Only schedule downlink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMacScheduler::m_dlOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("UlSchedOnly",
                   "Only schedule uplink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMacScheduler::m_ulOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedTti",
                   "Fix slot size",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMacScheduler::m_fixedTti),
                   MakeBooleanChecker ())
    .AddAttribute ("SymPerSlot",
                   "Number of symbols per slot in Fixed TTI mode",
                   UintegerValue (6),
                   MakeUintegerAccessor (&newradioFlexTtiMacScheduler::m_symPerSlot),
                   MakeUintegerChecker<uint8_t> ())
  ;
...
void
newradioFlexTtiMacScheduler::SetMacSchedSapUser (newradioMacSchedSapUser* sap)
{
  m_macSchedSapUser = sap;
}

void
newradioFlexTtiMacScheduler::SetMacCschedSapUser (newradioMacCschedSapUser* sap)
{
...
newradioFlexTtiMacScheduler::GetMacSchedSapProvider ()
{
  return m_macSchedSapProvider;
}

newradioMacCschedSapProvider*
newradioFlexTtiMacScheduler::GetMacCschedSapProvider ()
{
  return m_macCschedSapProvider;
}

void
newradioFlexTtiMacScheduler::ConfigureCommonParameters (Ptr<newradioPhyMacCommon> config)
{
...
void
newradioFlexTtiMacScheduler::DoSchedDlRlcBufferReq (const struct newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
newradioFlexTtiMacScheduler::DoSchedDlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMacScheduler::DoSchedUlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
uint8_t
newradioFlexTtiMacScheduler::UpdateDlHarqProcessId (uint16_t rnti)
{
...
uint8_t
newradioFlexTtiMacScheduler::UpdateUlHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
unsigned newradioFlexTtiMacScheduler::CalcMinTbSizeNumSym (unsigned mcs, unsigned bufSize, unsigned &tbSize)
{
...
void
newradioFlexTtiMacScheduler::DoSchedTriggerReq (const struct newradioMacSchedSapProvider::SchedTriggerReqParameters& params)
{
...
void
newradioFlexTtiMacScheduler::DoSchedUlMacCtrlInfoReq (const struct newradioMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMacScheduler::DoSchedSetMcs (int mcs)
{
  if (mcs >= 0 && mcs <= 28)
    {
      m_mcsDefaultDl = mcs;
...
bool
newradioFlexTtiMacScheduler::SortRlcBufferReq (newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters i, newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
void
newradioFlexTtiMacScheduler::RefreshDlCqiMaps (void)
{
...
void
newradioFlexTtiMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
newradioFlexTtiMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
newradioFlexTtiMacScheduler::DoCschedCellConfigReq (const struct newradioMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMacScheduler::DoCschedUeConfigReq (const struct newradioMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
newradioFlexTtiMacScheduler::DoCschedLcConfigReq (const struct newradioMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMacScheduler::DoCschedLcReleaseReq (const struct newradioMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMacScheduler::DoCschedUeReleaseReq (const struct newradioMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
