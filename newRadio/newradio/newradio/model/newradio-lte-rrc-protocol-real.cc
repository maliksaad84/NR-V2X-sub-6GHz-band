...
NS_LOG_COMPONENT_DEFINE ("newradioLteRrcProtocolReal");

const Time RRC_REAL_MSG_DELAY = MicroSeconds (500);

NS_OBJECT_ENSURE_REGISTERED (newradioLteUeRrcProtocolReal);

newradioLteUeRrcProtocolReal::newradioLteUeRrcProtocolReal ()
  :  m_ueRrcSapProvider (0),
    m_enbRrcSapProvider (0)
{
  m_ueRrcSapUser = new MemberLteUeRrcSapUser<newradioLteUeRrcProtocolReal> (this);
  m_completeSetupParameters.srb0SapUser = new LteRlcSpecificLteRlcSapUser<newradioLteUeRrcProtocolReal> (this);
  m_completeSetupParameters.srb1SapUser = new LtePdcpSpecificLtePdcpSapUser<newradioLteUeRrcProtocolReal> (this);
}
...
void
newradioLteUeRrcProtocolReal::DoDispose ()
{
...
TypeId
newradioLteUeRrcProtocolReal::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::newradioLteUeRrcProtocolReal")
    .SetParent<Object> ()
    .SetGroupName ("newradio")
    .AddConstructor<newradioLteUeRrcProtocolReal> ()
  ;
  return tid;
}

void
newradioLteUeRrcProtocolReal::SetLteUeRrcSapProvider (LteUeRrcSapProvider* p)
{
  m_ueRrcSapProvider = p;
}

LteUeRrcSapUser*
newradioLteUeRrcProtocolReal::GetLteUeRrcSapUser ()
{
  return m_ueRrcSapUser;
}

void
newradioLteUeRrcProtocolReal::SetUeRrc (Ptr<LteUeRrc> rrc)
{
  m_rrc = rrc;
}

void
newradioLteUeRrcProtocolReal::DoSetup (LteUeRrcSapUser::SetupParameters params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioLteUeRrcProtocolReal::DoSendRrcConnectionRequest (LteRrcSap::RrcConnectionRequest msg)
{
...
void
newradioLteUeRrcProtocolReal::DoSendRrcConnectionSetupCompleted (LteRrcSap::RrcConnectionSetupCompleted msg)
{
  Ptr<Packet> packet = Create<Packet> ();
...
void
newradioLteUeRrcProtocolReal::DoSendRrcConnectionReconfigurationCompleted (LteRrcSap::RrcConnectionReconfigurationCompleted msg)
{
...
void
newradioLteUeRrcProtocolReal::DoSendMeasurementReport (LteRrcSap::MeasurementReport msg)
{
  // re-initialize the RNTI and get the EnbLteRrcSapProvider for the
  // eNB we are currently attached to
  m_rnti = m_rrc->GetRnti ();
...
void
newradioLteUeRrcProtocolReal::DoSendNotifySecondaryCellConnected (uint16_t newradioRnti, uint16_t newradioCellId)
{
  m_rnti = m_rrc->GetRnti ();
  SetEnbRrcSapProvider ();
  ...
  rrcNotifyHeader.SetMessage (newradioCellId, newradioRnti);
...
void
newradioLteUeRrcProtocolReal::DoSendRrcConnectionReestablishmentRequest (LteRrcSap::RrcConnectionReestablishmentRequest msg)
{
  Ptr<Packet> packet = Create<Packet> ();
...
void
newradioLteUeRrcProtocolReal::DoSendRrcConnectionReestablishmentComplete (LteRrcSap::RrcConnectionReestablishmentComplete msg)
{
  Ptr<Packet> packet = Create<Packet> ();
...
void
newradioLteUeRrcProtocolReal::SetEnbRrcSapProvider ()
{
  uint16_t cellId = m_rrc->GetCellId ();

  // walk list of all nodes to get the peer eNB
  Ptr<LteEnbNetDevice> enbDev;
  Ptr<newradioEnbNetDevice> newradioEnbDev;
       ...
       ++i)
    {
      ...
      for (int j = 0;
           ...
           j++)
        {
          ...
          if (enbDev == 0)
            {
              // check if it is a newradio eNB
              newradioEnbDev = node->GetDevice (j)->GetObject <newradioEnbNetDevice> ();
              if (newradioEnbDev == 0)
                {
                  continue;
                }
                ...
                {
                  if (newradioEnbDev->HasCellId (cellId))
                    {
                      found = true;
                      break;
                    }
  ...
  if (enbDev != 0)
    {
      ...
      Ptr<newradioLteEnbRrcProtocolReal> enbRrcProtocolReal = enbDev->GetRrc ()->GetObject<newradioLteEnbRrcProtocolReal> ();
      enbRrcProtocolReal->SetUeRrcSapProvider (m_rnti, m_ueRrcSapProvider);
    }
  else if (newradioEnbDev != 0)
    {
      m_enbRrcSapProvider = newradioEnbDev->GetRrc ()->GetLteEnbRrcSapProvider ();
      Ptr<newradioLteEnbRrcProtocolReal> enbRrcProtocolReal = newradioEnbDev->GetRrc ()->GetObject<newradioLteEnbRrcProtocolReal> ();
      enbRrcProtocolReal->SetUeRrcSapProvider (m_rnti, m_ueRrcSapProvider);
    }
  else
    {
      NS_FATAL_ERROR ("Nor LTE eNB neither newradio eNB");
    }
}

void
newradioLteUeRrcProtocolReal::DoReceivePdcpPdu (Ptr<Packet> p)
{
  NS_LOG_FUNCTION (this);
  ...
  RrcConnectTonewradioHeader rrcConnectTonewradioHeader;
  ...
  switch ( rrcDlCcchMessage.GetMessageType () )
    ...
    case 3:
      ...
      break;
    case 4:
      // RrcConnectTonewradio
      p->RemoveHeader (rrcConnectTonewradioHeader);
      uint16_t newradioCellId = rrcConnectTonewradioHeader.GetMessage ();
      NS_LOG_INFO ("Recv RRC connect to newradio cellId " << newradioCellId);
      m_ueRrcSapProvider->RecvRrcConnectTonewradio (newradioCellId);
      break;
    }
}

void
newradioLteUeRrcProtocolReal::DoReceivePdcpSdu (LtePdcpSapUser::ReceivePdcpSduParameters params)
{
  // Get type of message received
...
NS_OBJECT_ENSURE_REGISTERED (newradioLteEnbRrcProtocolReal);

newradioLteEnbRrcProtocolReal::newradioLteEnbRrcProtocolReal ()
  :  m_enbRrcSapProvider (0)
{
  NS_LOG_FUNCTION (this);
  m_enbRrcSapUser = new MemberLteEnbRrcSapUser<newradioLteEnbRrcProtocolReal> (this);
}
...
void
newradioLteEnbRrcProtocolReal::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
newradioLteEnbRrcProtocolReal::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::newradioLteEnbRrcProtocolReal")
    .SetParent<Object> ()
    .SetGroupName ("Lte")
    .AddConstructor<newradioLteEnbRrcProtocolReal> ()
  ;
  return tid;
}

void
newradioLteEnbRrcProtocolReal::SetLteEnbRrcSapProvider (LteEnbRrcSapProvider* p)
{
  m_enbRrcSapProvider = p;
}

LteEnbRrcSapUser*
newradioLteEnbRrcProtocolReal::GetLteEnbRrcSapUser ()
{
  return m_enbRrcSapUser;
}

void
newradioLteEnbRrcProtocolReal::SetCellId (uint16_t cellId)
{
  m_cellId = cellId;
}

LteUeRrcSapProvider*
newradioLteEnbRrcProtocolReal::GetUeRrcSapProvider (uint16_t rnti)
{
...
void
newradioLteEnbRrcProtocolReal::SetUeRrcSapProvider (uint16_t rnti, LteUeRrcSapProvider* p)
{
...
void
newradioLteEnbRrcProtocolReal::DoSetupUe (uint16_t rnti, LteEnbRrcSapUser::SetupUeParameters params)
{
  ...
  if (csupIt == m_completeSetupUeParametersMap.end ())
    {
      ...
      LteRlcSapUser* srb0SapUser = new newradioRealProtocolRlcSapUser (this,rnti);
      LtePdcpSapUser* srb1SapUser = new LtePdcpSpecificLtePdcpSapUser<newradioLteEnbRrcProtocolReal> (this);
...
void
newradioLteEnbRrcProtocolReal::DoRemoveUe (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
  std::map<uint16_t, LteEnbRrcSapProvider::CompleteSetupUeParameters>::iterator
...
void
newradioLteEnbRrcProtocolReal::DoSendSystemInformation (uint16_t cellId, LteRrcSap::SystemInformation msg)
{
  ...
  for (NodeList::Iterator i = NodeList::Begin (); i != NodeList::End (); ++i)
    {
      ...
      for (int j = 0; j < nDevs; ++j)
        {
          Ptr<newradio::newradioUeNetDevice> ueDev = node->GetDevice (j)->GetObject <newradio::newradioUeNetDevice> ();
          if (ueDev != 0)
            {
              ueRrc = ueDev->GetRrc ();
              ...
              if (mcUeDev != 0)
                {
                  ...
                  else if (mcUeDev->GetnewradioRrc () != 0 && mcUeDev->GetnewradioRrc ()->GetCellId () == cellId)
                    {
                      NS_LOG_LOGIC ("sending SI to IMSI " << mcUeDev->GetImsi ());
                      Simulator::Schedule (RRC_REAL_MSG_DELAY,
                                           &LteUeRrcSapProvider::RecvSystemInformation,
                                           mcUeDev->GetnewradioRrc ()->GetLteUeRrcSapProvider (),
                                           msg);
                    }
                }
              else
...
void
newradioLteEnbRrcProtocolReal::DoSendRrcConnectionSetup (uint16_t rnti, LteRrcSap::RrcConnectionSetup msg)
{
  Ptr<Packet> packet = Create<Packet> ();
...
void
newradioLteEnbRrcProtocolReal::DoSendRrcConnectionReject (uint16_t rnti, LteRrcSap::RrcConnectionReject msg)
{
  Ptr<Packet> packet = Create<Packet> ();
...
void
newradioLteEnbRrcProtocolReal::DoSendRrcConnectionSwitch (uint16_t rnti, LteRrcSap::RrcConnectionSwitch msg)
{
  Ptr<Packet> packet = Create<Packet> ();
...
void
newradioLteEnbRrcProtocolReal::DoSendRrcConnectTonewradio (uint16_t rnti, uint16_t newradioId)
{
  NS_LOG_FUNCTION (this << " rnti " << rnti << " newradio cellId " << newradioId);
  Ptr<Packet> packet = Create<Packet> ();

  RrcConnectTonewradioHeader connectTonewradioHeader;
  connectTonewradioHeader.SetMessage (newradioId);

  packet->AddHeader (connectTonewradioHeader);

  NS_LOG_INFO (connectTonewradioHeader);
...
void
newradioLteEnbRrcProtocolReal::DoSendRrcConnectionReconfiguration (uint16_t rnti, LteRrcSap::RrcConnectionReconfiguration msg)
{
  Ptr<Packet> packet = Create<Packet> ();
...
void
newradioLteEnbRrcProtocolReal::DoSendRrcConnectionReestablishment (uint16_t rnti, LteRrcSap::RrcConnectionReestablishment msg)
{
...
void
newradioLteEnbRrcProtocolReal::DoSendRrcConnectionReestablishmentReject (uint16_t rnti, LteRrcSap::RrcConnectionReestablishmentReject msg)
{
  Ptr<Packet> packet = Create<Packet> ();
...
void
newradioLteEnbRrcProtocolReal::DoSendRrcConnectionRelease (uint16_t rnti, LteRrcSap::RrcConnectionRelease msg)
{
  Ptr<Packet> packet = Create<Packet> ();
...
void
newradioLteEnbRrcProtocolReal::DoReceivePdcpPdu (uint16_t rnti, Ptr<Packet> p)
{
  // Get type of message received
...
void
newradioLteEnbRrcProtocolReal::DoReceivePdcpSdu (LtePdcpSapUser::ReceivePdcpSduParameters params)
{
  // Get type of message received
...
Ptr<Packet>
newradioLteEnbRrcProtocolReal::DoEncodeHandoverPreparationInformation (LteRrcSap::HandoverPreparationInfo msg)
{
...
newradioLteEnbRrcProtocolReal::DoDecodeHandoverPreparationInformation (Ptr<Packet> p)
{
  HandoverPreparationInfoHeader h;
  p->RemoveHeader (h);
...
Ptr<Packet>
newradioLteEnbRrcProtocolReal::DoEncodeHandoverCommand (LteRrcSap::RrcConnectionReconfiguration msg)
{
...
newradioLteEnbRrcProtocolReal::DoDecodeHandoverCommand (Ptr<Packet> p)
{
  RrcConnectionReconfigurationHeader h;
  p->RemoveHeader (h);
...
newradioRealProtocolRlcSapUser::newradioRealProtocolRlcSapUser (newradioLteEnbRrcProtocolReal* pdcp, uint16_t rnti)
  : m_pdcp (pdcp),
    m_rnti (rnti)
{
}

newradioRealProtocolRlcSapUser::newradioRealProtocolRlcSapUser ()
{
}

void
newradioRealProtocolRlcSapUser::ReceivePdcpPdu (Ptr<Packet> p)
{
