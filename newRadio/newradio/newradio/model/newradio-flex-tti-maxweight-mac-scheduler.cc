#include <ns3/log.h>
#include <ns3/abort.h>
#include "newradio-flex-tti-maxweight-mac-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE ("newradioFlexTtiMaxWeightMacScheduler");

namespace newradio {

NS_OBJECT_ENSURE_REGISTERED (newradioFlexTtiMaxWeightMacScheduler);

class newradioFlexTtiMaxWeightMacCschedSapProvider : public newradioMacCschedSapProvider
{
public:
  newradioFlexTtiMaxWeightMacCschedSapProvider (newradioFlexTtiMaxWeightMacScheduler* scheduler);

  // inherited from newradioMacCschedSapProvider
  virtual void CschedCellConfigReq (const struct newradioMacCschedSapProvider::CschedCellConfigReqParameters& params);
  virtual void CschedUeConfigReq (const struct newradioMacCschedSapProvider::CschedUeConfigReqParameters& params);
  virtual void CschedLcConfigReq (const struct newradioMacCschedSapProvider::CschedLcConfigReqParameters& params);
  virtual void CschedLcReleaseReq (const struct newradioMacCschedSapProvider::CschedLcReleaseReqParameters& params);
  virtual void CschedUeReleaseReq (const struct newradioMacCschedSapProvider::CschedUeReleaseReqParameters& params);

private:
  newradioFlexTtiMaxWeightMacCschedSapProvider ();
  newradioFlexTtiMaxWeightMacScheduler* m_scheduler;
};

newradioFlexTtiMaxWeightMacCschedSapProvider::newradioFlexTtiMaxWeightMacCschedSapProvider ()
{
}

newradioFlexTtiMaxWeightMacCschedSapProvider::newradioFlexTtiMaxWeightMacCschedSapProvider (newradioFlexTtiMaxWeightMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
newradioFlexTtiMaxWeightMacCschedSapProvider::CschedCellConfigReq (const struct newradioMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
newradioFlexTtiMaxWeightMacCschedSapProvider::CschedUeConfigReq (const struct newradioMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
newradioFlexTtiMaxWeightMacCschedSapProvider::CschedLcConfigReq (const struct newradioMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
newradioFlexTtiMaxWeightMacCschedSapProvider::CschedLcReleaseReq (const struct newradioMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
newradioFlexTtiMaxWeightMacCschedSapProvider::CschedUeReleaseReq (const struct newradioMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

class newradioFlexTtiMaxWeightMacSchedSapProvider : public newradioMacSchedSapProvider
{
public:
  newradioFlexTtiMaxWeightMacSchedSapProvider (newradioFlexTtiMaxWeightMacScheduler* sched);

  virtual void SchedDlRlcBufferReq (const struct newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters& params);
  virtual void SchedTriggerReq (const struct newradioMacSchedSapProvider::SchedTriggerReqParameters& params);
  virtual void SchedDlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedDlCqiInfoReqParameters& params);
  virtual void SchedUlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedUlCqiInfoReqParameters& params);
  virtual void SchedUlMacCtrlInfoReq (const struct newradioMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params);
  virtual void SchedSetMcs (int mcs);
private:
  newradioFlexTtiMaxWeightMacSchedSapProvider ();
  newradioFlexTtiMaxWeightMacScheduler* m_scheduler;
};

newradioFlexTtiMaxWeightMacSchedSapProvider::newradioFlexTtiMaxWeightMacSchedSapProvider ()
{
}

newradioFlexTtiMaxWeightMacSchedSapProvider::newradioFlexTtiMaxWeightMacSchedSapProvider (newradioFlexTtiMaxWeightMacScheduler* sched)
  : m_scheduler (sched)
{
}

void
newradioFlexTtiMaxWeightMacSchedSapProvider::SchedDlRlcBufferReq (const struct newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
newradioFlexTtiMaxWeightMacSchedSapProvider::SchedTriggerReq (const struct newradioMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  m_scheduler->DoSchedTriggerReq (params);
}

void
newradioFlexTtiMaxWeightMacSchedSapProvider::SchedDlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
newradioFlexTtiMaxWeightMacSchedSapProvider::SchedUlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedUlCqiInfoReq (params);
}

void
newradioFlexTtiMaxWeightMacSchedSapProvider::SchedUlMacCtrlInfoReq (const struct newradioMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
newradioFlexTtiMaxWeightMacSchedSapProvider::SchedSetMcs (int mcs)
{
  m_scheduler->DoSchedSetMcs (mcs);
}
const unsigned newradioFlexTtiMaxWeightMacScheduler::m_macHdrSize = 0;
const unsigned newradioFlexTtiMaxWeightMacScheduler::m_subHdrSize = 4;
const unsigned newradioFlexTtiMaxWeightMacScheduler::m_rlcHdrSize = 3;


newradioFlexTtiMaxWeightMacScheduler::newradioFlexTtiMaxWeightMacScheduler ()
  : m_nextRnti (0),
    m_subframeNo (0),
    m_tbUid (0),
    m_macSchedSapUser (0),
    m_macCschedSapUser (0)
{
  ...
  m_macSchedSapProvider = new newradioFlexTtiMaxWeightMacSchedSapProvider (this);
  m_macCschedSapProvider = new newradioFlexTtiMaxWeightMacCschedSapProvider (this);
}
...
void
newradioFlexTtiMaxWeightMacScheduler::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  m_wbCqiRxed.clear ();
...
TypeId
newradioFlexTtiMaxWeightMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::newradioFlexTtiMaxWeightMacScheduler")
    .SetParent<newradioMacScheduler> ()
    .AddConstructor<newradioFlexTtiMaxWeightMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (100),
                   MakeUintegerAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedMcsDl",
                   "Fix MCS to value set in McsDlDefault",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_fixedMcsDl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultDl",
                   "Fixed DL MCS",
                   UintegerValue (1),
                   MakeUintegerAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_mcsDefaultDl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FixedMcsUl",
                   "Fix MCS to value set in McsUlDefault (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_fixedMcsUl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultUl",
                   "Fixed UL MCS (for testing)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_mcsDefaultUl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DlSchedOnly",
                   "Only schedule downlink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_dlOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("UlSchedOnly",
                   "Only schedule uplink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_ulOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("Algorithm",
                   "Max weight algorithm. Determines order of FlowStats element in priorty queue.",
                   EnumValue (newradioFlexTtiMaxWeightMacScheduler::EDF),
                   MakeEnumAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_algorithm),
                   MakeEnumChecker (newradioFlexTtiMaxWeightMacScheduler::DELIVERY_DEBT, "DeliveryDebt",
                                    newradioFlexTtiMaxWeightMacScheduler::EDF, "EDF"))
    .AddAttribute ("FixedTti",
                   "Fix slot size",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_fixedTti),
                   MakeBooleanChecker ())
    .AddAttribute ("SymPerSlot",
                   "Number of symbols per slot in Fixed TTI mode",
                   UintegerValue (6),
                   MakeUintegerAccessor (&newradioFlexTtiMaxWeightMacScheduler::m_symPerSlot),
                   MakeUintegerChecker<uint8_t> ())
  ;
...
void
newradioFlexTtiMaxWeightMacScheduler::SetMacSchedSapUser (newradioMacSchedSapUser* sap)
{
  m_macSchedSapUser = sap;
}

void
newradioFlexTtiMaxWeightMacScheduler::SetMacCschedSapUser (newradioMacCschedSapUser* sap)
{
  m_macCschedSapUser = sap;
}


newradioMacSchedSapProvider*
newradioFlexTtiMaxWeightMacScheduler::GetMacSchedSapProvider ()
{
  return m_macSchedSapProvider;
}

newradioMacCschedSapProvider*
newradioFlexTtiMaxWeightMacScheduler::GetMacCschedSapProvider ()
{
  return m_macCschedSapProvider;
}

void
newradioFlexTtiMaxWeightMacScheduler::ConfigureCommonParameters (Ptr<newradioPhyMacCommon> config)
{
...
void
newradioFlexTtiMaxWeightMacScheduler::DoSchedDlRlcBufferReq (const struct newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
newradioFlexTtiMaxWeightMacScheduler::DoSchedUlMacCtrlInfoReq (const struct newradioMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMaxWeightMacScheduler::DoSchedDlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMaxWeightMacScheduler::DoSchedUlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioFlexTtiMaxWeightMacScheduler::DoSchedSetMcs (int mcs)
{
  if (mcs >= 0 && mcs <= 28)
    {
      m_mcsDefaultDl = mcs;
...
void
newradioFlexTtiMaxWeightMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
uint8_t
newradioFlexTtiMaxWeightMacScheduler::UpdateDlHarqProcessId (uint16_t rnti)
{
...
uint8_t
newradioFlexTtiMaxWeightMacScheduler::UpdateUlHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
unsigned newradioFlexTtiMaxWeightMacScheduler::CalcMinTbSizeNumSym (unsigned mcs, unsigned bufSize, unsigned &tbSize)
{
  // Bisection line search is used to find the minimum number of slots (OFDM symbols)
  // needed to encode entire buffer.
  newradioMacPduHeader dummyMacHeader;
...
void
newradioFlexTtiMaxWeightMacScheduler::DoSchedTriggerReq (const struct newradioMacSchedSapProvider::SchedTriggerReqParameters& params)
{
...
//	}
  ...
  std::list<newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator itRlcBuf;
      ...
      while (symAvail > 0)
        {
          std::sort (m_flowHeap.begin (), m_flowHeap.end (),
                     newradioFlexTtiMaxWeightMacScheduler::CompareFlowWeightsEdf);                                                        // Sort flow heap by relative deadline
                  ...
                  if (itCqi != m_ueUlCqi.end ())                       // no cqi info for this UE
                    {
                      ...
                      SpectrumValue specVals (newradioSpectrumValueHelper::GetSpectrumModel (m_phyMacConfig));
...
bool
newradioFlexTtiMaxWeightMacScheduler::SortRlcBufferReq (newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters i, newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
void
newradioFlexTtiMaxWeightMacScheduler::RefreshDlCqiMaps (void)
{
...
void
newradioFlexTtiMaxWeightMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
newradioFlexTtiMaxWeightMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
  std::list<newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
void
newradioFlexTtiMaxWeightMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
newradioFlexTtiMaxWeightMacScheduler::DoCschedCellConfigReq (const struct newradioMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  // Read the subset of parameters used
  m_cschedCellConfig = params;
  //m_rachAllocationMap.resize (m_cschedCellConfig.m_ulBandwidth, 0);
  newradioMacCschedSapUser::CschedUeConfigCnfParameters cnf;
...
void
newradioFlexTtiMaxWeightMacScheduler::DoCschedUeConfigReq (const struct newradioMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
newradioFlexTtiMaxWeightMacScheduler::DoCschedLcConfigReq (const struct newradioMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  std::map <uint16_t, struct UeSchedInfo>::iterator itUe = m_ueSchedInfoMap.find (params.m_rnti);
  if (itUe != m_ueSchedInfoMap.end ())
...
void
newradioFlexTtiMaxWeightMacScheduler::DoCschedLcReleaseReq (const struct newradioMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  for (uint16_t i = 0; i < params.m_logicalChannelIdentity.size (); i++)
    {
      std::list<newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it = m_rlcBufferReq.begin ();
...
void
newradioFlexTtiMaxWeightMacScheduler::DoCschedUeReleaseReq (const struct newradioMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
