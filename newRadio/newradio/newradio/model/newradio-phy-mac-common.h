#ifndef SRC_newradio_MODEL_newradio_PHY_MAC_COMMON_H
#define SRC_newradio_MODEL_newradio_PHY_MAC_COMMON_H
...
//	}
  ...
  //std::list<newradioControlMessage> m_controlMessages;  // ctrl messages for this user
};
...
class newradioPhyMacCommon : public Object
{
public:
  newradioPhyMacCommon (void);
...
#endif /* SRC_newradio_MODEL_newradio_PHY_MAC_COMMON_H_ */
