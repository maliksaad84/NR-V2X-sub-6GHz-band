#ifndef newradio_3GPP_CHANNEL_H_
#define newradio_3GPP_CHANNEL_H_
...
#include "ns3/newradio-3gpp-propagation-loss-model.h"
 ...
 */
class newradio3gppChannel : public SpectrumPropagationLossModel
{
public:
  /**
* Constructor
*/
  ...
  */
  ...
  /**
   * Set the newradioPhyMacCommon object with the parameters of the scenario
   * @param a pointer to the newradioPhyMacCommon configuration
   */
  void SetConfigurationParameters (Ptr<newradioPhyMacCommon> ptrConfig);

  /**
   * Get the newradioPhyMacCommon object with the parameters of the scenario
   * @returns a pointer to the newradioPhyMacCommon configuration
   */
  ...
  /**
   * Set newradio3gppChannel in interference/data or reference signal mode.
   ...
   * With the second, on each link newradio3gppChannel uses the BF vectors associated to the link
...
#endif /* newradio_3GPP_CHANNEL_H_ */
