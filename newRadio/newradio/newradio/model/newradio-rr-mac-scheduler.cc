...
#include "newradio-rr-mac-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE ("newradioRrMacScheduler");

namespace newradio {

NS_OBJECT_ENSURE_REGISTERED (newradioRrMacScheduler);

class newradioRrMacSchedSapProvider : public newradioMacSchedSapProvider
{
public:
  newradioRrMacSchedSapProvider (newradioRrMacScheduler* sched);
...
private:
  newradioRrMacSchedSapProvider ();
  newradioRrMacScheduler* m_scheduler;
};

newradioRrMacSchedSapProvider::newradioRrMacSchedSapProvider ()
{
}

newradioRrMacSchedSapProvider::newradioRrMacSchedSapProvider (newradioRrMacScheduler* sched)
  : m_scheduler (sched)
{
...
void
newradioRrMacSchedSapProvider::SchedDlRlcBufferReq (const struct newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
newradioRrMacSchedSapProvider::SchedTriggerReq (const struct newradioMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  m_scheduler->DoSchedTriggerReq (params);
}

void
newradioRrMacSchedSapProvider::SchedDlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
newradioRrMacSchedSapProvider::SchedUlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedUlCqiInfoReq (params);
}

void
newradioRrMacSchedSapProvider::SchedUlMacCtrlInfoReq (const struct newradioMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
...
newradioRrMacScheduler::newradioRrMacScheduler ()
  : m_directions (""),
    ...
    m_macSchedSapUser (0)
{
  ...
  m_macSchedSapProvider = new newradioRrMacSchedSapProvider (this);
}
...
void
newradioRrMacScheduler::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  m_wbCqiRxed.clear ();
...
TypeId
newradioRrMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::newradioRrMacScheduler")
    .SetParent<newradioMacScheduler> ()
    .AddConstructor<newradioRrMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (100),
                   MakeUintegerAccessor (&newradioRrMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false),
                   MakeBooleanAccessor (&newradioRrMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
  ;
...
void
newradioRrMacScheduler::SetMacSchedSapUser (newradioMacSchedSapUser* sap)
{
  m_macSchedSapUser = sap;
}

newradioMacSchedSapProvider*
newradioRrMacScheduler::GetMacSchedSapProvider ()
{
  return m_macSchedSapProvider;
}

void
newradioRrMacScheduler::ConfigureCommonParameters (Ptr<newradioPhyMacCommon> config)
{
...
void
newradioRrMacScheduler::DoSchedDlRlcBufferReq (const struct newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
newradioRrMacScheduler::DoSchedDlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioRrMacScheduler::DoSchedUlCqiInfoReq (const struct newradioMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
/**/
void
newradioRrMacScheduler::SetScheduleDirection  (std::string patt)
{
...
void
newradioRrMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
uint8_t
newradioRrMacScheduler::UpdateDlHarqProcessId (uint16_t rnti)
{
...
uint8_t
newradioRrMacScheduler::UpdateUlHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
bool
newradioRrMacScheduler::DoSchedDlTriggerReq (const struct newradioMacSchedSapProvider::SchedTriggerReqParameters& params,
...
bool
newradioRrMacScheduler::DoSchedUlTriggerReq (const struct newradioMacSchedSapProvider::SchedTriggerReqParameters& params,
                                           newradioMacSchedSapUser::SchedConfigIndParameters& ret,
                                           unsigned int frameNum,
                                           unsigned int sfNum,
                                           unsigned int slotNum)
...
void
newradioRrMacScheduler::DoSchedTriggerReq (const struct newradioMacSchedSapProvider::SchedTriggerReqParameters& params)
{
...
void
newradioRrMacScheduler::DoSchedUlMacCtrlInfoReq (const struct newradioMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
bool
newradioRrMacScheduler::SortRlcBufferReq (newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters i, newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
void
newradioRrMacScheduler::RefreshDlCqiMaps (void)
{
...
void
newradioRrMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
newradioRrMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
  std::list<newradioMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
...
void
newradioRrMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
/*
void
newradioRrMacScheduler::DoCschedCellConfigReq (const struct newradioMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioRrMacScheduler::DoCschedUeConfigReq (const struct newradioMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
newradioRrMacScheduler::DoCschedLcConfigReq (const struct newradioMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioRrMacScheduler::DoCschedLcReleaseReq (const struct newradioMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
newradioRrMacScheduler::DoCschedUeReleaseReq (const struct newradioMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
