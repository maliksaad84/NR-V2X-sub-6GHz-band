#ifndef SRC_newradio_MODEL_newradio_MAXWEIGHT_MAC_SCHEDULER_H_
#define SRC_newradio_MODEL_newradio_MAXWEIGHT_MAC_SCHEDULER_H_
...
class newradioFlexTtiMaxWeightMacScheduler : public newradioMacScheduler
{
public:
  ...
  newradioFlexTtiMaxWeightMacScheduler ();

  virtual ~newradioFlexTtiMaxWeightMacScheduler ();
  ...
  friend class newradioFlexTtiMaxWeightMacSchedSapProvider;
  friend class newradioFlexTtiMaxWeightMacCschedSapProvider;
...
#endif /* SRC_newradio_MODEL_newradio_MAXWEIGHT_MAC_SCHEDULER_H_ */
