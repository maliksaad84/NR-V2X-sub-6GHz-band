#ifndef newradio_MAC_CSCHED_SAP_H
#define newradio_MAC_CSCHED_SAP_H
 ...
 * in the SamplenewradioMacCschedSapProvider and SampleFfMacCschedSapuser classes
 */
class newradioMacCschedSapProvider
{
public:
  virtual ~newradioMacCschedSapProvider ();
...
class newradioMacCschedSapUser
{
public:
  virtual ~newradioMacCschedSapUser ();
...
#endif /* newradio_MAC_CSCHED_SAP_H */
