#ifndef newradio_RADIO_BEARER_STATS_CALCULATOR_H_
#define newradio_RADIO_BEARER_STATS_CALCULATOR_H_
 ...
 */
class newradioBearerStatsCalculator : public LteStatsCalculator
{
public:
  /**
   * Class constructor
   */
  newradioBearerStatsCalculator ();

  /**
    * Class constructor
    */
  newradioBearerStatsCalculator (std::string protocolType);
...
#endif /* newradio_RADIO_BEARER_STATS_CALCULATOR_H_ */
