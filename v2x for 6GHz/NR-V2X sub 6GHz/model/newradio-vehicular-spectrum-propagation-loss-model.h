#ifndef newradio_VEHICULAR_SPECTRUM_PROPAGATION_LOSS_MODEL_H_
#define newradio_VEHICULAR_SPECTRUM_PROPAGATION_LOSS_MODEL_H_
...
#include <ns3/newradio-vehicular-propagation-loss-model.h>
...
//class newradio3gppBuildingsPropagationLossModel;
 ...
 */
class newradioVehicularSpectrumPropagationLossModel : public SpectrumPropagationLossModel
{
public:
  /**
* Constructor
*/
  newradioVehicularSpectrumPropagationLossModel ();
  /**
  * Destructor
  */
  virtual ~newradioVehicularSpectrumPropagationLossModel ();
   ...
   * @param a pointer to the associated newradioVehicularAntennaArrayModel
   */
  void AddDevice (Ptr<NetDevice>, Ptr<newradioVehicularAntennaArrayModel>);
...
private:
  ...
  std::map < Ptr<NetDevice>, Ptr<newradioVehicularAntennaArrayModel> > m_deviceAntennaMap;
...
#endif /* newradio_VEHICULAR_SPECTRUM_PROPAGATION_LOSS_MODEL_H_ */
